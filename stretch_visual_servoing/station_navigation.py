    ...
    try:
        ...
        while True:
            ...
            if wafer_station is not None:
                ...
                draw_origin(image, camera_info, wafer_station, (255, 0, 0))
                x,y,z = wafer_station * 100.0
                ...
                center = np.round(dh.pixel_from_3d(wafer_station, camera_info)).astype(np.int32)
