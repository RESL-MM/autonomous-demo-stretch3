## Stretch3 Autonomous Demo Instructions (26-08)
...
- Once the robot is powered on, connect to the local stretch3 wifi network
	- name: `stretch3`; password: `61294295`
...
> WARNING: please make sure the stretch gripper is unobstructed, the range of motion of the robot is not constrained, and that there is no obstructions within about a 1 meter radius of the robot; the stretch will go through its full ROM and open and close the gripper, please make sure any obstructions (liek tables or the vacuum wand) are removed
